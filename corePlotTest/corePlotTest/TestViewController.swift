...
//  corePlotTest
//
//  Created by justin on 2019/7/12.
...
class TestViewController : UIViewController, CPTScatterPlotDataSource, CPTAxisDelegate {
    private var scatterGraph : CPTXYGraph? = nil
    
    typealias plotDataType = [CPTScatterPlotField : Double]
    private var dataForPlot = [plotDataType]()
    @IBOutlet weak var scatterView: UIView!
    ...
    override func viewDidAppear(_ animated : Bool)
    {
        ...
        let hostingView = scatterView as! CPTGraphHostingView
